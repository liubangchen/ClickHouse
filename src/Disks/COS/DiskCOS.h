...
public:
    ...
    const String & getPath() const override { return cos_root_path; };
    ...
    const String getType() const override { return "cos"; }

private:
    bool tryReserve(UInt64 bytes);
    String  makeCosKey(const String & path) const;
    void copyCosFile(const String & from_path, const String & to_path);
    void removeCosFile(const String & path);

private:
    const String name;
    std::shared_ptr<Aws::S3::S3Client> client;
    const String bucket;
    const String cos_root_path;
